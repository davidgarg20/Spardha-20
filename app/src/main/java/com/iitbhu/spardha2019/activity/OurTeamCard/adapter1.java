package com.iitbhu.spardha2019.activity.OurTeamCard;
...
import com.iitbhu.spardha2019.activity.ourTeam;
...
public class adapter1 extends RecyclerView.Adapter<adapter1.ViewHolder> {
    ...
    public adapter1(List<DataContacts> myDataset,Context context) {
        mDataset = myDataset; this.mContext = context;
    }
...
//        }
    ...
    @Override
    public adapter1.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                  int viewType) {
        View v;
        int x = getItemViewType(viewType);
        if (x % 2 == 0) {
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_layout_team1, parent, false);
...
//            webview=(WebView)v.findViewById(R.id.webview);
            ...
            designation.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Log.e("designationclick", "onClick: "+mDataset.get(position).getDesignation() );
                    //ourteam.sendRequest(mDataset.get(position).getDesignation());
                    //ourTeam.getInstance().sendRequest();
                    if (mContext instanceof ourTeam) {
                        ((ourTeam)mContext).sendRequest(mDataset.get(position).getDesignation());
                    }
                    else
                    {
                        Log.e("desig", "onClick: hi" );
                    }
                }
            });
